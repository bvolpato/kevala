...
export const KEV_SHADERS = { RECUR, RECUR_LANES };
...
export class GpuKev {
  ...
  async init() {
    ...
    const names = { RMS, GATES, CONV, SAVE_TAIL, QKNORM, RECUR: this.lanes ? RECUR_LANES : RECUR, GNORM, APREP, SAVE_KV, ATTN, SILUMUL, GATHER };
